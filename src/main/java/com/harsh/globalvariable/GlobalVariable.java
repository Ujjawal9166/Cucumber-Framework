...
public class GlobalVariable {
    ...
    public static String GradeOrProgramName = "PrgGradexO0XjOvsxZ";

    public static String GradeorProgramBatchName = "17";
   ...
   // public static String Subname;
    ...
    public static String academyLocation ="DXTXXnXvXrsXty-Dehradun EM";
    ...
    public static String CoursesubjectName ="SubName pKDyoS7w";
    public static String CoursesubjectCode;
    public static String AssessmenMethodtName;
	...
	public static String AssessmenntSchemeName;
	public static String AssessmenntType= "Auto Asssessment Type";
	public static String AssessmenntSubType= "Auto Asssessment SubType";
